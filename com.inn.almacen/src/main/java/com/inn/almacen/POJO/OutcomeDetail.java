...
@NamedQuery(name = "OutcomeDetail.getAllByFk", query = "select new com.inn.almacen.WRAPPER.KardexDetailWrapper(i.id, i.product.nombre, i.cantidad, i.precioDeVenta, i.saldo, i.cantidad*i.precioDeVenta) from OutcomeDetail i where i.outcome.id=:outcome_fk")
