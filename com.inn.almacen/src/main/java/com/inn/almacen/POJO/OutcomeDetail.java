...
@NamedQuery(name = "OutcomeDetail.getById", query = "select new com.inn.almacen.WRAPPER.OutcomeDetailWrapper(i.id, i.cantidad, i.precioDeVenta, i.saldo, i.outcome.id, i.outcome.fecha, i.outcome.estado, i.outcome.client.id, i.outcome.client.razonSocial, i.outcome.client.ruc, i.outcome.client.correo, i.outcome.client.contacto, i.outcome.client.direccion, i.outcome.user.id, i.outcome.user.nombre, i.outcome.userAuth.id, i.outcome.userAuth.nombre, i.product.id, i.product.prodDesc, i.product.prodCode, i.product.precio, i.product.stock, i.product.estado, i.product.category.catId, i.product.category.catName, i.product.supplier.id, i.product.supplier.razonSocial, i.product.supplier.ruc, i.product.supplier.contacto) from OutcomeDetail i where i.id=:id")
@NamedQuery(name = "OutcomeDetail.getAllOutcomeDetail", query = "select new com.inn.almacen.WRAPPER.OutcomeDetailWrapper(i.id, i.cantidad, i.precioDeVenta, i.saldo, i.outcome.id, i.outcome.fecha, i.outcome.estado, i.outcome.client.id, i.outcome.client.razonSocial, i.outcome.client.ruc, i.outcome.client.correo, i.outcome.client.contacto, i.outcome.client.direccion, i.outcome.user.id, i.outcome.user.nombre, i.outcome.userAuth.id, i.outcome.userAuth.nombre, i.product.id,  i.product.prodDesc, i.product.prodCode, i.product.precio, i.product.stock, i.product.estado, i.product.category.catId, i.product.category.catName, i.product.supplier.id, i.product.supplier.razonSocial, i.product.supplier.ruc, i.product.supplier.contacto) from OutcomeDetail i")
@NamedQuery(name = "OutcomeDetail.getAllByFk", query = "select new com.inn.almacen.WRAPPER.KardexDetailWrapper(i.id, i.product.prodDesc, i.cantidad, i.precioDeVenta, i.product.precio, i.saldo, i.cantidad*i.precioDeVenta) from OutcomeDetail i where i.outcome.id=:outcome_fk")
