...
@NamedQuery(name = "IncomeDetail.getAllByFk", query = "select new com.inn.almacen.WRAPPER.KardexDetailWrapper(i.id, i.product.nombre, i.cantidad, i.precioVentaUnit, i.saldo, i.cantidad*i.precioVentaUnit) from IncomeDetail i where i.income.id=:income_fk")
