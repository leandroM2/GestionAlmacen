...
/*@NamedQuery(name = "IncomeDetail.getById",
        query = "select new com.inn.almacen.WRAPPER.IncomeDetailWrapper" +
        "(i.id, i.cantidad, i.precioVentaUnit, i.oldPrecioVenta, i.saldo, i.income.id, i.income.fecha, i.income.estado," +
        " i.income.user.id, i.income.user.nombre, i.income.userAuth.id, i.income.userAuth.nombre, i.product.prodId," +
        " i.product.prodDesc, i.product.prodCode,  i.product.prodStock, i.product.prodState, i.product.category.catId," +
        " i.product.category.catName, i.product.supplier.id, i.product.supplier.razonSocial, i.product.supplier.ruc," +
        " i.product.supplier.contacto, " +
        " i.type.typeId, i.type.typeName, i.location.locationId, i.location.locationFloor) " +
