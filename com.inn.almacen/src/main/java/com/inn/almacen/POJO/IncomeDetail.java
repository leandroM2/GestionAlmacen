...
@NamedQuery(name = "IncomeDetail.getById", query = "select new com.inn.almacen.WRAPPER.IncomeDetailWrapper(i.id, i.cantidad, i.precioVentaUnit, i.oldPrecioVenta, i.saldo, i.income.id, i.income.fecha, i.income.estado, i.income.user.id, i.income.user.nombre, i.income.userAuth.id, i.income.userAuth.nombre, i.product.id, i.product.prodDesc, i.product.prodCode, i.product.precio, i.product.stock, i.product.estado, i.product.category.catId, i.product.category.catName, i.product.supplier.id, i.product.supplier.razonSocial, i.product.supplier.ruc, i.product.supplier.contacto) from IncomeDetail i where i.id=:id")
@NamedQuery(name = "IncomeDetail.getAllIncomeDetail", query = "select new com.inn.almacen.WRAPPER.IncomeDetailWrapper(i.id, i.cantidad, i.precioVentaUnit, i.oldPrecioVenta, i.saldo, i.income.id, i.income.fecha, i.income.estado, i.income.user.id, i.income.user.nombre, i.income.userAuth.id, i.income.userAuth.nombre, i.product.id, i.product.prodDesc, i.product.prodCode, i.product.precio, i.product.stock, i.product.estado, i.product.category.catId, i.product.category.catName, i.product.supplier.id, i.product.supplier.razonSocial, i.product.supplier.ruc, i.product.supplier.contacto) from IncomeDetail i")
...
@NamedQuery(name = "IncomeDetail.getAllOrderByFk", query = "select new com.inn.almacen.WRAPPER.KardexDetailWrapper(i.product.id, i.product.prodDesc, i.cantidad, i.precioVentaUnit, i.cantidad*i.precioVentaUnit) from IncomeDetail i where i.income.id=:income_fk")
